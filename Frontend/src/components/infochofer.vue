<template>
    ...
    <!-- <vs-dialog  v-model="active" class="dialog" @close="handleClose">
        ...
        <vs-card class="card">
            ...
            <template #interactions>
               <div v-for="(estrella, index) in estrellas" :key="index">
                    <span class="material-icons-outlined" id="estrella">
                        star
                    </span>

                </div>
                <vs-button class="comentarios" shadow primary>
                    <span class="material-icons-outlined">
                        comment
                    </span>
        ...
        <div class="comentarioscontenedor">
            <div class="titulocomentarios">
                Comentarios como chofer
                <div v-for="(comentario,index) in comentarios" :key="index">
                    <div v-if="comentario.esChofer" class="comentariocontenedor">
            ...
            <div class="titulocomentarios">
                ...
                <div v-for="(comentario,index) in comentarios" :key="index">
                    <div v-if="comentario.esChofer==false" class="comentariocontenedor">
                        <p class="nombreusuario">
                            {{comentario.nombre}}
                        </p>
                        <div>
...
export default {
    ...
    data() {
        ...
        console.log(Math.floor(this.valoraciontotal))

        console.log(this.valoraciontotal - (Math.floor(this.valoraciontotal)))
