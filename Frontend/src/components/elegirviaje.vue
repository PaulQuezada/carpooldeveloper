   ...
   methods: {
    ...
    openNotification(titulo,duration,text,color,position) {
       ...
       initializeMap() {
            ...
            this.openNotification("Mueve el marker azul para marcar tu punto de subida",3000,"","success","top-right")
            ...
            this.map = new mapboxgl.Map({
               ...
               center: [this.$store.state.destinoseleccionado.lng, this.$store.state.destinoseleccionado.lat],
               zoom: 13,
            });
       ...
       ,centrarruta() {
            ...
            bounds.extend(this.$store.state.origenseleccionado);
